...
vision_system::vision_system()
{
    ...
    ObjRec.loadImageDB() && canRun ? canRun = true : canRun = false;
...
void vision_system::keyboardControl()
{
	...
	case 27: case 'q':  case 'Q':
	    ...
	    break;
	case 'o': case 'O':
//		boost::thread L_OR(boost::bind(&ObjectRecognition::matchObsvToDB, &ObjRec, _Limg, name)); 
		ObjRec.matchObsvToDB(_Limg, name);
		break;
    }
}
