...
const string defaultQueryImageName = "./data/matching_to_many_images/query.png";
const string defaultFileWithTrainImages = "./data/matching_to_many_images/train/trainImages.txt";
const string defaultDirToSaveResImages = "./data/matching_to_many_images/results";
